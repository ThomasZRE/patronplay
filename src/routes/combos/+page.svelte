                ...
                <div class="grid grid-4">
                    {#each duokeys.slice(0, 4) as key}
                        <div data-tooltip={prices.Duos[key][1]}>
                            <Cards showSelect={false} product={capitalize(key)} price={prices.Duos[key][0]} src={`/img/duos/${prices.Duos[key][2]}`}/>
                        </div>
                    {/each}
                </div>
                <div class="grid grid-4">
                ...
                <div class="grid grid-3">
                    ...
                    <div data-tooltip={prices.Tridentes[key][1]}>
                        <Cards 
                            ...
                            src={`/img/tridentes/${prices.Tridentes[key][2]}`}
                        />
                    </div>
                    {/each}
                </div>
                ...
                <div class="grid grid-3">
                    ...
                    <div data-tooltip={prices.Combos[key][1]}>
                        <Cards 
                            ...
                            src={`/img/combos/${prices.Combos[key][2]}`}
                        />
                    </div>
                    {/each}
                </div>
