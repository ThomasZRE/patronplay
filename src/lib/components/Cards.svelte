...
<style>
    [role="button"].pico-background-jade-400 {
        --pico-background-color: var(--pico-color-jade-400);
        --pico-border-color: var(--pico-color-jade-400); 
    }

    [role="button"].pico-background-jade-400:hover {
    ...
    .image {
        aspect-ratio: 4/5;  /* Make images square */
        width: 100%;
        padding: 0;
        margin: 0;
    }
